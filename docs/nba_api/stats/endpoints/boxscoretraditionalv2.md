...
##### [nba_api/stats/endpoints/boxscoretraditionalv2.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/boxscoretraditionalv2.py)
...
| [_**EndRange**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#EndRange)       | end_range                 |            |   `Y`    |          | 
...
| [_**RangeType**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#RangeType)     | range_type                |            |   `Y`    |          | 
...
| [_**StartRange**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#StartRange)   | start_range               |            |   `Y`    |          | 
