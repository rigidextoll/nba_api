# ScoreboardV2
##### [nba_api/stats/endpoints/scoreboardv2.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/scoreboardv2.py)
...
|-------------------------------------------------------------------------------------------------------------------|---------------------------|:-------------:|:--------:|:--------:|
| [_**DayOffset**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#DayOffset) | day_offset                | `^-{0,1}\d+$` |   `Y`    |          | 
| [_**GameDate**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#GameDate)   | game_date                 |               |   `Y`    |          | 
