...
##### [nba_apiv3/stats/endpoints/boxscoretraditionalv3.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/boxscoretraditionalv3.py)
