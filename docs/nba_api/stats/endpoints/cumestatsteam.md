# CumeStatsTeam
##### [nba_api/stats/endpoints/cumestatsteam.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/cumestatsteam.py)
...
|---------------------------------------------------------------------------------------------------------------------|---------------------------|:----------------------------------------------------------:|:--------:|:--------:|
| [_**GameIDs**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#GameIDs)       | game_ids                  |                                                            |   `Y`    |          | 
