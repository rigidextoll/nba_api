# LeadersTiles
##### [nba_api/stats/endpoints/leaderstiles.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/leaderstiles.py)
...
| [_**Stat**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#Stat)                 | stat                      | `^(PTS)\|(REB)\|(AST)\|(FG_PCT)\|(FT_PCT)\|(FG3_PCT)\|(STL)\|(BLK)$` |   `Y`    |          | 
