...
##### [nba_api/stats/endpoints/teamhistoricalleaders.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/teamhistoricalleaders.py)
...
| [_**SeasonID**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#SeasonID) | season_id                 | `^\d{5}$` |   `Y`    |          | 
