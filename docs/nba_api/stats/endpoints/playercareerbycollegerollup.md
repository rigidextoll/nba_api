...
##### [nba_api/stats/endpoints/playercareerbycollegerollup.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/playercareerbycollegerollup.py)
