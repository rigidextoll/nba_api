# HomePageV2
##### [nba_api/stats/endpoints/homepagev2.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/homepagev2.py)
...
| [_**StatType**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#StatType)         | stat_type                 |   `^(Traditional)\|(Advanced)\|(Tracking)$`    |   `Y`    |          | 
