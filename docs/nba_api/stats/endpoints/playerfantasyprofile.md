...
##### [nba_api/stats/endpoints/playerfantasyprofile.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/playerfantasyprofile.py)
...
|-----------------------------------------------------------------------------------------------------------------------|---------------------------|:----------------------------------------------:|:--------:|:--------:|
| [_**MeasureType**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#MeasureType) | measure_type_base         |                   `^(Base)$`                   |   `Y`    |          | 
| [_**PaceAdjust**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#PaceAdjust)   | pace_adjust_no            |                    `^(N)$`                     |   `Y`    |          | 
| [_**PerMode**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#PerMode)         | per_mode36                |        `^(Totals)\|(PerGame)\|(Per36)$`        |   `Y`    |          | 
...
| [_**PlusMinus**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#PlusMinus)     | plus_minus_no             |                    `^(N)$`                     |   `Y`    |          | 
| [_**Rank**_](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#Rank)               | rank_no                   |                    `^(N)$`                     |   `Y`    |          | 
