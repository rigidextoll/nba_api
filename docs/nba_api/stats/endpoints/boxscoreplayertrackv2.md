...
##### [nba_api/stats/endpoints/boxscoreplayertrackv2.py](https://github.com/rigidextoll/nba_api/blob/master/src/nba_api/stats/endpoints/boxscoreplayertrackv2.py)
