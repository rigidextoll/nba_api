...
[![Build: CircleCI](https://img.shields.io/circleci/project/github/rigidextoll/nba_api.svg?style=for-the-badge&logo=circleci)](https://circleci.com/gh/rigidextoll/nba_api)
[![License: MIT](https://img.shields.io/github/license/rigidextoll/nba_api.svg?style=for-the-badge)](https://github.com/rigidextoll/nba_api/blob/master/LICENSE)
...
- [Requests/Response Options](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/examples.md#endpoint-usage-example)
  - Proxy Support, Custom Headers, and Timeout Settings
  - Return Types and Raw Responses
- [Static Data Sets](https://github.com/rigidextoll/nba_api/blob/master/docs/nba_api/stats/examples.md#static-usage-examples)
  - Reduce HTTP requests for common and frequently accessed player and team data.
- [Jupyter Notebooks](https://github.com/rigidextoll/nba_api/tree/master/docs/examples)
...
- [Table of Contents](https://github.com/rigidextoll/nba_api/tree/master/docs/table_of_contents.md)
- [Package Structure](https://github.com/rigidextoll/nba_api/tree/master/docs/package_structure.md)
- [Endpoints](/docs/nba_api/stats/endpoints)
- Static Data Sets
  - [players.py](https://github.com/rigidextoll/nba_api/tree/master/docs/nba_api/stats/static/players.md)
  - [teams.py](https://github.com/rigidextoll/nba_api/tree/master/docs/nba_api/stats/static/teams.md)
...
*See [Contributing to the NBA_API](https://github.com/rigidextoll/nba_api/blob/master/CONTRIBUTING.md) for complete details.*
...
If you find a new, changed, or deprecated endpoint, open a [GitHub Issue](https://github.com/rigidextoll/nba_api/issues)

## Bugs

Encounter a bug, [report a bug](https://github.com/rigidextoll/nba_api/issues).

# License & Terms of Use

## API Client Package

The `nba_api` package is Open Source with an [MIT License](https://github.com/rigidextoll/nba_api/blob/master/LICENSE).
